...
// Method to push status to timeline when updating the order status
...
// Hook to ensure initial status is pushed on creation
OrderSchema.pre('save', function (this: IOrder, next: (err?: mongoose.CallbackError) => void) {
